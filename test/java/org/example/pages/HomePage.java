...
public class HomePage {
    ...
    // Common locators (use accessibility ids / names from page source)
    ...
    private final By favouritesButton = MobileBy.AccessibilityId("automationNavigationHeaderLikesButton");
    private final By basketButton = MobileBy.AccessibilityId("automationNavigationHeaderBasketButton");
